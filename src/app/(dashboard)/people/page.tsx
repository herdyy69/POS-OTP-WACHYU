  ...
  return (
    <div className='card space-y-4'>
      <div className='space-y-1'>
        <h1 className='plabs-title-medium-18 text-greyscale-9 sm:plabs-title-medium-20'>List orang</h1>
        <p className='plabs-body-regular-12 text-greyscale-6 sm:plabs-body-regular-14'>
          Kelola orang pada halaman ini.
        </p>
      </div>
      <div className='flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between'>
        ...
        <Link href='/people/create' className='btn-green text-xs sm:text-sm'>
          <span className='hidden sm:inline'>Tambah Orang</span>
